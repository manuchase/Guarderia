...
function Logo({ size = 10 }) {
  return (
    <div
      ...
      style={{ width: size * 4, height: size * 4, background: "#5FB3A1", boxShadow: "0 8px 20px -6px rgba(95,179,161,0.5)" }}
    >
      <div className="absolute inset-0 flex">
        <div className="w-1/2 h-full flex items-center justify-center">
          <Brain size={size * 1.6} color="white" strokeWidth={1.8} />
        </div>
        <div className="w-1/2 h-full flex items-center justify-center">
          <Smile size={size * 1.6} color="white" strokeWidth={1.8} />
        </div>
      </div>
      <div className="absolute inset-y-0 left-1/2 w-px" style={{ background: "rgba(255,255,255,0.3)" }} />
    </div>
  );
}
  ...
  return (
    <div className="mt-10 flex flex-col items-center">
      <GlassCard className="w-full p-8" style={{ border: "1.5px solid rgba(95,179,161,0.3)" }}>
        <h1 className="text-2xl font-semibold mb-1" style={{ color: "#2E3A36" }}>Iniciar sesión</h1>
        <p className="text-sm mb-6" style={{ color: "#7A8A85" }}>Ingresa con el usuario y contraseña que te asignaron.</p>
